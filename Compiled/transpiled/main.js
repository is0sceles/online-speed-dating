...
/******/ 	__webpack_require__.p = "compiled/transpiled";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signinController = __webpack_require__(8);
	...
	var routes = [{
	  path: '/',
	  component: _appController2.default
	}, {
	  path: '/signin',
	  component: _signinController2.default
	}, {
	  path: '/video',
	  component: _videoController2.default
	}, {
	  path: '/signup',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _signinTemplate = __webpack_require__(9);
	...
	var Login = {
	  template: _signinTemplate2.default.template,
	  data: function data() {
	    return {
	      username: '',
	      password: ''
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "/Users/elliottbirch/Desktop/online-speed-dating/App/Client/Views/signinTemplate.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
